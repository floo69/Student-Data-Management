...
export default function Index() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Publications</h2>}
        >
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">urnal
                                               </th>
                                               <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                                                   Date
                                               </th>
                                           ...
                                           {publications.map((publication) => (
                                               <tr key={publication.id}>
                                                   ...
                                                   <td className="whitespace-nowrap px-6 py-4">
                                                       ...
                                                       <button
                                                           onClick={() => confirmPublicationDeletion(publication)}
               ...
               <div className="p-6">
                   <h2 className="text-lg font-medium text-gray-900">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                       Once this publication is deleted, all of its resources and data will be permanently deleted.
                   </p>
