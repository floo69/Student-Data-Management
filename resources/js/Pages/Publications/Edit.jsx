...
export default function Edit({ publication }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Publication</h2>}
        >
    ...
    <InputError message={errors.publication_date} className="mt-2" />
                                ...
                                <PrimaryButton disabled={processing}>Update Publication</PrimaryButton>
                           </form>
                       </div>
                   </div>
               </div>
