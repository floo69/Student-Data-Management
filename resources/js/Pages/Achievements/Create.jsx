...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Add Achievement</h2>}
        >
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <PrimaryButton disabled={processing}>Add Achievement</PrimaryButton>
                            </form>
                        </div>
                    </div>
                </div>
