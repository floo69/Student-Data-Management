...
export default function Edit({ internship }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Internship</h2>}
        >
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <form onSubmit={submit} className="space-y-6">
                               ...
                               <PrimaryButton disabled={processing}>Update Internship</PrimaryButton>
                           </form>
                       </div>
                   </div>
               </div>
