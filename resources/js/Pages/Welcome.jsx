...
export default function MergedLanding({
  auth,
  canLogin,
  canRegister,
  laravelVersion,
    ...
    <div className="min-h-screen bg-gray-100">
          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="text-center">
              ...
              <p className="mt-5 max-w-xl mx-auto text-xl text-gray-500">
                Efficiently manage and showcase your academic and professional
                achievements in a secure and organized way.
              </p>
      ...
      <footer class="bg-gray-100 py-4">
        <div class="container mx-auto px-4 text-center">
          <p class="text-gray-600 text-lg">Created by Floyd Carlo</p>
          <div className="flex justify-center space-x-6 md:order-2">
            <a
              href="https://www.linkedin.com/in/floyd-carlo-63642b287/"
